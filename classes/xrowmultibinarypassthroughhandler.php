...
/*!
  \class eZFilePassthroughHandler xrowmultibinarypassthroughhandler.php
  \ingroup eZBinaryHandlers
  \brief Handles file downloading by passing the file through PHP

*/
class xrowMultiBinaryPassthroughHandler extends eZBinaryFileHandler
{
    const HANDLER_ID = 'ezfilepassthrough';

    function xrowMultiBinaryPassthroughHandler()
    {
